...
> Discord economy bot, coins shop gambling jobs 2026 — free, open-source, easy to set up.

<br>

## ✨ Features

💰 &nbsp;**Currency system** — earn, spend, and transfer server coins

🏪 &nbsp;**Shop** — buy custom roles and items with coins

🃏 &nbsp;**Gambling** — slots, blackjack, coinflip games

💼 &nbsp;**Jobs** — work commands to earn coins

🏦 &nbsp;**Bank** — deposit and protect your coins

📈 &nbsp;**Richest** — global and server leaderboard
